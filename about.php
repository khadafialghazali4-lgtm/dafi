...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .subtitle{color:var(--muted);margin:0 0 18px;line-height:1.6;max-width:70ch;font-size:15px}
    ...
    .list{margin:10px 0 0;padding-left:18px;color:var(--muted);font-size:13px;line-height:1.8}
    ...
    .step span{display:block;color:var(--muted);font-size:12px;margin-top:4px;line-height:1.6}
...
<body>
    ...
    <main class="main">
      <div class="topbar">
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
          <a class="btn" href="home.php">Kembali</a>
          <a class="btn primary" href="kontak.php">Hubungi</a>
        </div>
      </div>

      <section class="section" aria-label="About">
        <h1>Tentang Alghazali Art</h1>
        <p class="subtitle">
          <b>Alghazali Art</b> adalah layanan pembuatan website yang fokus pada tampilan modern, performa baik,
          dan struktur yang rapi—mulai dari website sederhana sampai sistem yang lebih kompleks.
        </p>

        <div class="grid2">
          <div class="card">
            <h3>Visi</h3>
            <p>Membantu bisnis & personal brand tampil profesional di internet dengan website yang responsif, elegan, dan mudah dikembangkan.</p>
            <ul class="list">
              <li>Desain modern dan nyaman dilihat</li>
              <li>Kode rapi, mudah maintenance</li>
              <li>Siap integrasi API & database</li>
            </ul>
          </div>

          <div class="card">
            <h3>Misi</h3>
            <p>Membangun solusi digital yang terukur dan sesuai kebutuhan, dengan proses kerja yang jelas dan transparan.</p>
            <ul class="list">
              <li>Analisis kebutuhan sebelum build</li>
              <li>Implementasi bertahap (step-by-step)</li>
        ...
        <div class="grid2">
          <div class="card">
            ...
            <p>Setiap proyek dibuat dengan standar modern: responsif, aman, dan siap berkembang.</p>
            <ul class="list">
              <li>Layout sidebar + footer (konsisten)</li>
              <li>Chatbot AI di setiap halaman</li>
              <li>Dokumentasi penggunaan (basic)</li>
              <li>Optimasi dasar performa</li>
            </ul>
          </div>

          <div class="card">
            <h3>Jenis layanan</h3>
            <p>Kami menyediakan beberapa level paket sesuai kebutuhan.</p>
            <ul class="list">
              <li>Low: landing/company profile</li>
              <li>Medium: website dinamis + CMS</li>
              <li>High: web app/SaaS + integrasi</li>
              <li>Analisis: riset/algoritma/ML</li>
              <li>Enterprise: ERP/EEM skala besar</li>
            </ul>
          </div>
        </div>

        <div class="timeline" aria-label="Alur kerja">
          <div class="step">
            <b>1) Brief & kebutuhan</b>
            <span>Kita definisikan tujuan, target user, fitur inti, dan referensi desain.</span>
          </div>
          <div class="step">
            <b>2) Desain & struktur</b>
            <span>Buat layout (sidebar/footer), komponen UI, serta rancangan halaman.</span>
          </div>
          <div class="step">
            <b>3) Implementasi bertahap</b>
            <span>Build halaman per halaman + integrasi (chatbot, form, API, database sesuai paket).</span>
          </div>
          <div class="step">
            <b>4) Uji & rilis</b>
            <span>Uji responsif, performa, bugfix, lalu deploy ke hosting.</span>
          </div>
        </div>

        <div style="margin-top:16px; display:flex; gap:10px; flex-wrap:wrap;">
          <a class="btn primary" href="layanan.php">Lihat Layanan</a>
          <a class="btn" href="konpetensi.php">Lihat Konpetensi</a>
        </div>
      </section>
  ...
  <section class="chatPanel" id="chatPanel" aria-label="Chatbot Alghazali Art">
    ...
    <div class="hint">Tanyakan: “ceritakan Alghazali Art” atau “paket apa yang cocok untuk saya?”</div>

    <div class="chatBody" id="chatBody">
      <div class="msg bot">Halo! Saya chatbot Alghazali Art. Mau tanya tentang layanan, paket, atau proses kerja?</div>
    </div>

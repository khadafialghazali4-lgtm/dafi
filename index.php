  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .hero::before{
      ...
      background: radial-gradient(600px 220px at 18% 10%, rgba(124,92,255,.28), transparent 60%),
                  radial-gradient(560px 220px at 85% 30%, rgba(46,229,157,.16), transparent 60%);
      pointer-events:none;
    }
    .heroGrid{
      position:relative;
    ...
    .kpi .txt{font-size:12px; color:var(--muted); margin-top:4px}
    .previewCard{
      position:relative;
      border-radius: var(--radius);
      border:1px solid var(--line);
    ...
    .previewCard ul{margin:0; padding-left:18px; color:var(--muted); line-height:1.7; font-size:13px}
    .grid3{
      display:grid;
...
<body>
    ...
    <main class="main">
      <div class="topbar">
        ...
        <div class="cta">
          ...
          <a class="btn" href="layanan.php">Lihat Layanan</a>
        </div>
      </div>
      ...
      <section class="hero" aria-label="Hero">
        <div class="heroGrid">
          <div>
            <h1>Bangun Website Modern untuk Bisnis & Karya Kamu</h1>
            <p>
              <b>Alghazali Art</b> membantu kamu membuat website yang cepat, responsif, dan elegan:
              dari landing page, company profile, sampai web app dan sistem terintegrasi.
            </p>

            <div class="kpiRow">
              <div class="kpi">
                <div class="num">Responsive</div>
                <div class="txt">Nyaman di HP, tablet, laptop</div>
              </div>
              <div class="kpi">
                <div class="num">Modern UI</div>
                <div class="txt">Look & feel elegan dan bersih</div>
              </div>
              <div class="kpi">
                <div class="num">Chatbot AI</div>
                <div class="txt">Asisten untuk tanya layanan 24/7</div>
              </div>
            </div>

            <div style="margin-top:14px; display:flex; gap:10px; flex-wrap:wrap;">
              <a class="btn primary" href="layanan.php">Mulai dari Paket</a>
              <a class="btn" href="about.php">Tentang Alghazali Art</a>
            </div>
          </div>

          <div class="previewCard" aria-label="Preview">
            <div class="badge">⚡ Highlight</div>
            <ul>
              <li>Struktur halaman rapi (sidebar + footer)</li>
              <li>Komponen reusable (mudah dikembangkan)</li>
              <li>Chatbot AI terpasang di setiap menu</li>
              <li>Siap integrasi API & database (opsional)</li>
            </ul>

            <div class="grid3">
              <div class="card">
                <h3>Desain</h3>
                <p>UI modern, tipografi bersih, fokus kenyamanan.</p>
              </div>
              <div class="card">
                <h3>Teknis</h3>
                <p>Struktur PHP rapi, mudah maintenance & scaling.</p>
              </div>
              <div class="card">
                <h3>Dukungan</h3>
                <p>Support perbaikan bug & pengembangan fitur.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="chatPanel" id="chatPanel" aria-label="Chatbot Alghazali Art">
    ...
    <div class="hint">Tanyakan: “paket website apa yang cocok?” atau “bisa buat sistem booking?”</div>

    <div class="chatBody" id="chatBody">
      <div class="msg bot">Halo! Saya chatbot Alghazali Art. Kamu mau buat website seperti apa?</div>
    </div>
  ...
  <script>
    ...
    // Chatbot API call (via backend proxy to protect keys)
